...
namespace yixiaozi.WinForm.Control.TagCloud
{
    public partial class TagCloudControl : UserControl
    {
        ...
        {
            public SolidBrush drawBrush = new System.Drawing.SolidBrush(RedomColor());
            public Font drawFont = new System.Drawing.Font("Calibri", 8f, FontStyle.Regular);
            ...
            public OutputDesign(string font, float size, Color color)
            {
                ...
                this.drawFont = new System.Drawing.Font(font, size, FontStyle.Regular);
                //this.drawFont = new System.Drawing.Font(font, size, FontStyle.Regular);
            }
        }
        ...
        public static Color RedomColor()
        {
            Random r = new Random();
            int num = r.Next(7, 10);
            Color[] colors = new Color[11];
            colors[0] = Color.FromArgb(90, 90, 90);
            colors[1] = Color.Azure;
            colors[2] = Color.PowderBlue;
            colors[3] = Color.LightSkyBlue;
            colors[4] = Color.DeepSkyBlue;
            colors[5] = Color.CadetBlue;
            colors[6] = Color.Gold;
            colors[7] = Color.Orange;
            colors[8] = Color.OrangeRed;
        ...
        public void SetAllDesigns(bool update)
        {
            ...
            //OutputDesigns.Add(new OutputDesign("Calibri", 112f, Color.FromArgb(255, 153, 0)));
            OutputDesigns.Add(new OutputDesign("Calibri", 8f, RedomColor()));
            OutputDesigns.Add(new OutputDesign("Calibri", 8f, RedomColor()));
            OutputDesigns.Add(new OutputDesign("Calibri", 8f, RedomColor()));
            OutputDesigns.Add(new OutputDesign("Calibri", 8f, RedomColor()));
            OutputDesigns.Add(new OutputDesign("Calibri", 8f, RedomColor()));
        ...
        private void TagCloudControl_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Right)
            {
                ...
                contextMenuStrip.Left = System.Windows.Forms.Control.MousePosition.X;
                contextMenuStrip.Top = System.Windows.Forms.Control.MousePosition.Y;
            }
        }
